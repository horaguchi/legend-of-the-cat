...
"Legend of the Cat" is a game that:

* Places units on a 9x9 grid.
* Each unit produces resources.
* It has a very simple appearance.
* Has an overall time limit and randomly selects one of 3 victory conditions.
